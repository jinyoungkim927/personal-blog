...
4. Develop [Game Theory](/snippets/game-theory/) intuition + build game theory simulations with agents.
...
##### d) Develop Game Theory Intuition + Build AI [Game Theory](/snippets/game-theory/) Simulation
