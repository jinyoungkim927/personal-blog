...
date: 2026-01-04
displayDate: "Written 20th Feb 2025"
tags:
  - AI
---
...
Versions: [초지능 전후 (한국어)](/snippets/doc-2fcc119d/)
...
4. Develop <span style={{color: "#999", cursor: "not-allowed"}}>Game Theory</span> intuition + build game theory simulations with agents.
...
Note: I do not consider timelines on when superintelligence is achieved very useful, because there is  [Radical or Knightean Uncertainty](/snippets/radical-or-knightean-uncertainty/). People do not forecast using the same definitions, and the variance is incredibly high as demonstrated in the following plot from those close to the metal.
...
![Screenshot 2025-03-16 at 11.53.09 am.png](./Screenshot_2025-03-16_at_11.53.09_am.png)
...
I believe human relationships and authenticity will become increasingly precious. Having the right network becomes increasingly important. This is because, as [Ishita](/snippets/ishita/) said, knowing the right people makes achieving your goals easier. 
...
##### d) Develop Game Theory Intuition + Build AI <span style={{color: "#999", cursor: "not-allowed"}}>Game Theory</span> Simulation

> I plan on developing strong game theory intuition to better predict the world as AGI experiences step changes, and find further edge through building game theory [Simulations](/snippets/simulations/) with AI agents.
