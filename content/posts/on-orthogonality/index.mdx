...
![High-dimensional thought space visualization showing points representing individual thoughts in a multi-dimensional space](/orthogonality-thought-space.png)
...
![Low rank approximation visualization showing projection from high-dimensional space to shared communication dimension](/orthogonality-communication-projection.png)
...
![Visualization of argument with two orthogonal components clashing, showing miscommunication as rotated basis projection](/orthogonality-miscommunication.png)
