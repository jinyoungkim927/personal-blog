...
import thoughtSpace from "./01_thought_space-2.png"
import communicationProjection from "./02_communication_projection.png"
import pcDescriptions from "./PC_descriptions.png"
import featureOrthogonality from "./feature_orthogonality_score.png"
...
<Figure src={thoughtSpace} alt="High-dimensional thought space visualization" caption="My brain" />
...
<Figure src={communicationProjection} alt="Low rank approximation visualization" caption="Communication as projection to a shared dimension" />
...
<Figure src={pcDescriptions} alt="Principal component descriptions" caption="Three main factors from PCA analysis" />
...
<Figure src={featureOrthogonality} alt="Feature orthogonality score" caption="Contribution & Impact has the lowest mean correlation" />

**Contribution & Impact** has the lowest mean correlation, making it the most independent from my other life dimensions, signalling it's an orthogonal asset.
