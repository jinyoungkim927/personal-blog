...
1. The most convincing reason I find is that teaching reasoning through showing the models traces of reasoning from human domain experts can inherit deep flaws that we base our understanding of the world on. 5000 years ago, we would’ve trained these models on animism, 3000 years ago on theism, 300 years ago on newtonian mechanics, and 50 years ago on quantum mechanics. (ADD A FOORNOTE to 300 years ago on theism, 300 years ago on newtonian mechanics to: credit to Vedant Khanna: https://www.vedant.space)
